...
import { ROUTESLOGINED, ROUTESUSER } from './../sidebar/sidebar.component';
...
export class NavbarComponent implements OnInit {
    ...
    constructor(location: Location,  private element: ElementRef, private router: Router, private courseService: CourseService) {
    ...
    ngOnInit(){
      ...
      this.listTitles2 = ROUTESLOGINED.filter(listTitle => listTitle);
      this.listTitlesUser = ROUTESUSER.filter(listTitle => listTitle);
